    ...
    <>
      ...
      {isOpen && (
        <>
          ...
          {/* 모달 - 중앙 배치 */}
          <div
            className={`fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[420px] max-h-[80vh] flex flex-col rounded-xl shadow-2xl border ${
              isDarkMode
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-5">
              {!hasModel ? (
                ...
                <div>
                  <div
                    className={`p-4 rounded-lg text-[13px] leading-relaxed mb-4 ${
                      isDarkMode
